            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-10 offset-lg-2">
                        <div class="row">
                            <div class='col-lg-2'><p>Barang</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $baranggudang->barang->id }}</p></div>
									<div class='col-lg-2'><p>Gudang</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $baranggudang->gudang->id }}</p></div>
