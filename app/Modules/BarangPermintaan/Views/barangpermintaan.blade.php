    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <form action="{{ route('barangpermintaan.index') }}" method="get">
                    ...
                    <div class="col-3">  
						{!! button('barangpermintaan.create', $title) !!}  
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('barangpermintaan.show','', $item->id) !!}
										{!! button('barangpermintaan.edit', $title, $item->id) !!}
                                        {!! button('barangpermintaan.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
